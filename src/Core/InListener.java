...
public class InListener implements KeyListener{
	...
	public void keyPressed(KeyEvent arg0) {
		...
		case p1Punch:
			if (main.p1CanAtk) main.playerAttacked(1, Player.PUNCH);
			break;
			
		case p1Kick:
			if (main.p1CanAtk) main.playerAttacked(1, Player.KICK);
			break;
			
		case p1Block:
			if (main.p1CanAtk) main.playerAttacked(1, Player.BLOCK);
			break;
			
		case p2Punch:
			if (main.p2CanAtk) main.playerAttacked(2, Player.PUNCH);
			break;
			
		case p2Kick:
			if (main.p2CanAtk) main.playerAttacked(2, Player.KICK);
			break;
			
		case p2Block:
			if (main.p2CanAtk) main.playerAttacked(2, Player.BLOCK);
			break;
